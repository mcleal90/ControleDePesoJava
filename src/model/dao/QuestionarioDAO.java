...
public class QuestionarioDAO {
    ...
    public List<Questionario> read() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                m.setCod_questionario(rs.getInt("cod_questionario"));
    ...
    public void delete (Questionario m){
        Connection con = ConnectionFactory.getConnection();
        PreparedStatement stmt = null;
        
        try {
            stmt = con.prepareStatement("DELETE FROM questionario WHERE cod_questionario=?");
            stmt.setInt(1, m.getCod_questionario());
